                ...
                <tbody>
                    <?php foreach ($datos as $dato) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="#" data-href="<?php echo base_url() . '/unidades/restaurar/' . $dato['id']; ?>" data-bs-toggle="modal" data-bs-target="#modal-confirma" title="Restaurar Registro" class="btn btn-danger"><i class="fas fa-trash-restore"></i></a>
                            </td>
                        </tr>
                    <?php } ?>
