<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            ...
            <div>
                <p>
                    <a href="<?php echo base_url();?>/toperacion/nuevo" class="btn btn-info">Agregar</a>
                ...
                <table id="datatablesSimple" class="table table-sm table-striped table-hover" style="width:100%">
                    ...
                    <?php foreach($datos as $dato) { ?>
                        <tr>
                            ...
                            <td>
                            <a href="<?php echo base_url();?>/toperacion/editar/<?php echo $dato['id'];?>" class="btn btn-warning" title="Editar Registro"><i class="far fa-edit"></i></a>
                            <a href="#" data-href="<?php echo base_url().'/toperacion/eliminar/'. $dato['id']; ?>" data-bs-toggle="modal" 
