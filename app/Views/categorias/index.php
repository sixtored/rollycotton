                ...
                <table id="datatablesSimple" class="table table-sm table-striped table-hover" style="width:100%">
                    ...
                    <?php foreach($datos as $dato) { ?>
                        <tr>
                            ...
                            <td>
                            <a href="<?php echo base_url();?>/categorias/editar/<?php echo $dato['id'];?>" class="btn btn-warning" title="Editar Registro"><i class="far fa-edit"></i></a>
                            <a href="#" data-href="<?php echo base_url().'/categorias/eliminar/'. $dato['id']; ?>" data-bs-toggle="modal" 
