<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">    
            ...
            <div class="col-10">
                    <a href="<?php echo base_url().'/rlaboreos/nuevo/'. $campo['id'] ;?>" class="btn btn-info">Agregar</a>
                ...
                <tbody>
                    <?php foreach ($datos as $dato) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url(); ?>/rlaboreos/editar/<?php echo $dato['id']; ?>" title="Editar registro" class="btn btn-warning"><i class="far fa-edit"></i></a>    
                                <a href="#" data-href="<?php echo base_url().'/rlaboreos/eliminar/'. $dato['id']; ?>" data-bs-toggle="modal" 
