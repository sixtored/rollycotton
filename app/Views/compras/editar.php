<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            ...
            <form method="POST" action="<?php echo base_url(); ?>/unidades/guardar" autocomplete="off">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <input class="form-control" id="nombre_corto" name="nombre_corto" type="text" value="<?php echo $dato['nombre_corto']; ?>" required />
                        </div>
                    </div>
                </div>
                <p>
