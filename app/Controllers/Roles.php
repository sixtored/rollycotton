...
class Roles extends BaseController
{
    ...
    protected $roles, $permisos, $detalleper, $session;
    protected $reglas;
    ...
    public function __construct()
    {
        ...
        $this->reglas = [
            'nombre' => [
                'rules' => 'required|is_unique[roles.nombre,id,{id}]',
                'errors' => [
    ...
    public function index($activo = 1)
    {
        ...
        $acceder = $this->detalleper->verificapermisos($this->session->id_rol, 'RolesLista');
        //$acceder = true ;
    ...
    public function nuevo()
    {
        ...
        $acceder = $this->detalleper->verificapermisos($this->session->id_rol, 'RolesNuevo');
        //$acceder = true ;
    ...
    public function editar($id, $valid = null)
    {
        ...
        $acceder = $this->detalleper->verificapermisos($this->session->id_rol, 'RolesEditar');
        //$acceder = true ;
    ...
    public function detalles($id_rol)
    {
        ...
        $acceder = $this->detalleper->verificapermisos($this->session->id_rol, 'RolesPermisos');
        //$acceder = true ;
